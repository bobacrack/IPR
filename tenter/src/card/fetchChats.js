export const fetchChats = (onCompleteCallback) => {
    const url = 'http://217.160.215.31:6969/api/v1/chat'; // Adjust the URL according to your API endpoint
...
export const fetchDislikes = (onCompleteCallback, id) => {
    const url = 'http://217.160.215.31:6969/api/v1/dislike/' + id;// Adjust the URL according to your API endpoint
    fetch(url)
        .then((response) => {
            if (!response.ok) {
